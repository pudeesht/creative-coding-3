...
class Particle{
    ...
    constructor(effect)
    {
        ...
        this.speedy;
        this.alpha=0;
        this.history=[{x:this.x,y:this.y,alpha:this.alpha}];
    ...
    update()
    {
        ...
        if (this.timer>0)
        {
            ...
            let k=this.history.length;
            let straightlinecount=0
            if ( this.history.length>30)
            {
                for(let i=0; i<10;i++)
                    {
                        if (this.history[k-1].alpha==0)
                        {
                            straightlinecount++;
                        }
                        k--;
...
class Effect{
    ...
    drawtext()
    {
        ...
        gradient2.addColorStop(0.6,"rgb(110,0,255)");
        gradient2.addColorStop(0.8,"rgb(0,200,0)");
        ...
        // this.ctx.fillText("JS", this.canvas.width * 0.5, this.canvas.height * 0.5);
    ...
    outline()
    {
        ...
        this.fillStyle=gradient1;
        this.ctx.textBaseline="middle";
        this.ctx.fillText("JS", this.canvas.width*0.5,this.canvas.height*0.5,this.width);
        this.ctx.lineWidth = 2;
        // this.ctx.strokeStyle=gradient2;
        this.ctx.strokeText("JS", this.canvas.width * 0.5, this.canvas.height * 0.5);
